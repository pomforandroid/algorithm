// ShortestPath.cpp : Defines the entry point for the application.
//
...
void testDijkstra() {
    string filename = "D:\\wupengcong\\c++\\algorithm\\ShortestPath\\testG1.txt";
    int V = 5;
...
void testBellmanFord() {
    string filename = "D:\\wupengcong\\c++\\algorithm\\ShortestPath\\testG2.txt";
