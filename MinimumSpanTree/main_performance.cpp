...
int main() {
    ...
    string filename1 = "D:\\wupengcong\\c++\\algorithm\\MinimumSpanTree\\testG1.txt";
    int V1 = 8;

    string filename2 = "D:\\wupengcong\\c++\\algorithm\\MinimumSpanTree\\testG2.txt";
    int V2 = 250;

    string filename3 = "D:\\wupengcong\\c++\\algorithm\\MinimumSpanTree\\testG3.txt";
    int V3 = 1000;

    string filename4 = "D:\\wupengcong\\c++\\algorithm\\MinimumSpanTree\\testG4.txt";
    int V4 = 10000;
